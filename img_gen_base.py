...
METADATA_FILE_NAME = r'C:\Users\cb162\.spyder-py3\Img_gen\metadata\all-traits.json'; 
...
for item in all_images:
    ...
    im2 = Image.open(f'./circles/{circle_files[item["Circle"]]}.png').convert('RGBA')
    im3 = Image.open(f'./squares/{square_files[item["Square"]]}.png').convert('RGBA')
